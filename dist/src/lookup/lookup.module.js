...
LookupModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([lookup_entity_1.default])],
        controllers: [lookup_controller_1.LookupController, lookup_controller_1.LookupControllerV2],
